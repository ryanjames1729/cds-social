  ...
  return (
    <>
     ...
     <Header /> 
      ...
      <div className="bg-gray-100 dark:bg-transparent h-screen w-screen -mt-12">
                <div className="container mx-auto flex flex-col items-center py-12 sm:py-24 mt-12">
                    <div className="w-11/12 sm:w-2/3 lg:flex justify-center items-center flex-col  mb-5 sm:mb-10">
                        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-center text-gray-800 dark:text-white font-black leading-7 md:leading-10">
                            ...
                            <span className="text-indigo-700"> Thoughts </span>
                             You Want
                        </h1>
